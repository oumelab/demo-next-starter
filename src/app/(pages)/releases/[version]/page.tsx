...
export default async function ReleasePage({ params }: ReleasePageProps) {
  ...
  return (
    <div className="container mx-auto max-w-4xl py-10 md:py-16 relative z-10">
